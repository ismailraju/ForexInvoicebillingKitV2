 ...
 * or the method invoke( CanonCommand cmd );
 * 
...
public abstract class BaseCanonCamera implements EdsObjectEventHandler {
  ...
  protected static ConcurrentLinkedQueue<CanonCommand<?>> queue = new ConcurrentLinkedQueue<CanonCommand<?>>();
  ...
  public File[] shoot(final EdsSaveTo saveTo) {
    ...
    ShootCommand sc=new ShootCommand(saveTo);
      System.out.println("fgfg"+sc);
    System.out.println(sc);
    return executeNow(sc);
  }
  ...
  public ShootCommand shootAsync(final EdsSaveTo saveTo, final int shotAttempts) {
   ...
   * @return the EnumData
   */
  public SetPropertyCommand.EnumData setPropertyAsync(
      final EdsPropertyID property,
      final DescriptiveEnum<? extends Number> value) {
    return execute(new SetPropertyCommand.EnumData(property, value));
  }

  // some external users of edsdk4j (like Matlab) don't realize they can use
  // setProperty(EdsPropertyID, long) with Integer values
  ...
  public GetPropertyCommand.Size getPropertySizeAsync(
      final EdsPropertyID property) {
  ...
  public GetPropertyCommand.Type getPropertyTypeAsync(
      final EdsPropertyID property) {
  ...
  public GetPropertyDescCommand getPropertyDescAsync(
      final EdsPropertyID property) {
  ...
  public NativeLong apply(NativeLong inEvent, EdsBaseRef inRef,
    ...
    for (final EdsObjectEventHandler handler : objectEventHandlers) {
  ...
  public GetPropertyCommand.CustomFunction getCustomFunctionAsync(
      final EdsCustomFunction customFunction) {
  ...
  // TODO: figure out why this generally returns null unless queried just after
  // the output device has been changed
  ...
  public Boolean setCustomFunction(final EdsCustomFunction customFunction,
      final long value) {
    return executeNow(new SetPropertyCommand.CustomFunction(customFunction,
        value));
  }

  public SetPropertyCommand.CustomFunction setCustomFunctionAsync(
      final EdsCustomFunction customFunction, final long value) {
  ...
  public SetPropertyCommand.HardDriveDirectoryStructure setHardDriveDirectoryStructureAsync(
      final String value) {
  ...
  public SetPropertyCommand.ImageQuality setImageQualityAsync(
      final EdsImageQuality value) {
  ...
  public SetPropertyCommand.WhiteBalance setWhiteBalanceAsync(
      final EdsWhiteBalance value) {
  ...
  public SetPropertyCommand.ColorTemperature setColorTemperatureAsync(
      final long value) {
  ...
  public SetPropertyCommand.WhiteBalanceShift setWhiteBalanceShiftAsync(
      final int[] value) {
  ...
  public SetPropertyCommand.ColorSpace setColorSpaceAsync(
      final EdsColorSpace value) {
  ...
  public SetPropertyCommand.PictureStyle setPictureStyleAsync(
      final EdsPictureStyle value) {
  ...
  public SetPropertyCommand.PictureStyleDescription setPictureStyleDescriptionAsync(
      final EdsPictureStyleDesc value) {
  ...
  public Boolean setPictureStyleDescription(final long contrast,
      final long sharpness, final long saturation, final long colorTone,
      final EdsFilterEffect filterEffect, final EdsTonigEffect toningEffect) {
    return executeNow(new SetPropertyCommand.PictureStyleDescription(contrast,
        sharpness, saturation, colorTone, filterEffect, toningEffect));
  }

  public SetPropertyCommand.PictureStyleDescription setPictureStyleDescriptionAsync(
      final long contrast, final long sharpness, final long saturation,
      final long colorTone, final EdsFilterEffect filterEffect,
      final EdsTonigEffect toningEffect) {
    return execute(new SetPropertyCommand.PictureStyleDescription(contrast,
        sharpness, saturation, colorTone, filterEffect, toningEffect));
  }
  ...
  public SetPropertyCommand.MeteringMode setMeteringModeAsync(
      final EdsMeteringMode value) {
  ...
  public SetPropertyCommand.ApertureValue setApertureValueAsync(
      final EdsAv value) {
  ...
  public SetPropertyCommand.ExposureCompensation setExposureCompensationAsync(
      final EdsExposureCompensation value) {
  ...
  public SetPropertyCommand.MovieShootingStatus setMovieShootingStatusAsync(
      final long value) {
  ...
  public SetPropertyCommand.LiveViewOutputDevice setLiveViewOutputDeviceAsync(
      final EdsEvfOutputDevice value) {
  ...
  public SetPropertyCommand.LiveViewMode setLiveViewModeAsync(
      final boolean value) {
  ...
  public SetPropertyCommand.LiveViewWhiteBalance setLiveViewWhiteBalanceAsync(
      final EdsWhiteBalance value) {
  ...
  public SetPropertyCommand.LiveViewColorTemperature setLiveViewColorTemperatureAsync(
      final long value) {
  ...
  public Boolean setLiveViewDepthOfFieldInPreview(final boolean value) {
    return executeNow(new SetPropertyCommand.LiveViewDepthOfFieldInPreview(
        value));
  }

  public SetPropertyCommand.LiveViewDepthOfFieldInPreview setLiveViewDepthOfFieldInPreviewAsync(
      final boolean value) {
  ...
  public SetPropertyCommand.LiveViewAutoFocusMode setLiveViewAutoFocusModeAsync(
      final EdsEvfAFMode value) {
  ...
  public SetPropertyCommand.LiveViewZoomRatio setLiveViewZoomRatioAsync(
      final EdsEvfZoom value) {
  ...
  public SetPropertyCommand.LiveViewZoomPosition setLiveViewZoomPositionAsync(
      final EdsPoint value) {
  ...
  // TODO: Test if the following can be written to.. documentation lists
  // kEdsPropID_AEModeSelect constants, but these are no longer present in
  // include files
  ...
  // kEdsPropID_AEModeSelect constants, but these are no longer present in
  // include files
  public SetPropertyCommand.ShootingMode setShootingModeAsync(
